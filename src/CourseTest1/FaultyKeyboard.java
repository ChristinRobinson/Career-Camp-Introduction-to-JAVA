...
//Faulty Keyboard
//Send Feedback
//Some keys on your keyboard are faulty. When you press a key, it may register more than once. That means if you want to type "code", the keyboard may interpret it as "code", "cccoddee" or "coode" or "codeeeee", etc. So, by pressing the keys C, O, D, and E in that order, you may get any of the above-mentioned words.
...
//1 <= N <= 10^5
//1 <= L <= 10^6
//where L is the total number of letters in all the 2*N words
//Time limit: 1 sec
//Sample Input 1
//2
//code
